    ...
    <div class="card border-light shadow mt-3">
        ...
        <div class="container-fluid mt-3">
            <div class="d-flex justify-content-end">
                <button type="button" class="btn btn-outline-primary btn-sm shadow-sm" data-bs-toggle="modal" data-bs-target="#modalInstansi">
            ...
            <div class="table-responsive">
                <table class="table table-sm table-hover" id="tableUser">
                    <thead>
                        <tr>
                            <th class="px-0">#</th>
                            <th class="px-0">Nama Instansi</th>
                            <th class="px-0"></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-outline-danger border-light btn-sm shadow-sm" data-bs-toggle="modal" data-bs-target="#modalDestroy" data-bs-theid="{{ $instansi->id }}">
...
<!-- Modal Kasbon Keluar-->
<div class="modal fade" id="modalInstansi" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalInstansiLabel" aria-hidden="true">
            ...
            <form action="/instansi/store" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body px-4 pb-4 text-center">
                    <div class="d-flex justify-content-between me-3 mt-3">
                        <h4 class="text-start display-6">Instansi</h4>
...
<div class="modal fade" id="modalDestroy" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalDestroyLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content rounded-4 shadow">
            <form action="/instansi/destroy" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body px-4 pb-4 text-center">
